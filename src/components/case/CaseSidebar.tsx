...
import { CaseModule, UserRole } from '@/types';
            ...
            <div key={group} className="mb-4">
              {groupLabels[group] && (
                <button
                  ...
                  className="w-full flex items-center justify-between p-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                >
